...
export default function Home({ posts }) {
  return (
    <>
      ...
      <h3 className="text-center text-lg">Mixing, Mastering, Tuition</h3>
      ...
      <p className="text-md mt-10 mb-10">
        ...
        flare upon request. <br /> <br /> Just hit the button below to get in touch and give your
        music the polish it deserves.
      </p>
