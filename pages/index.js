...
export default function Home({ posts }) {
  return (
    <>
      ...
      <div className="flex justify-center sm:my-16 lg:my-1">
        <Image
          className=""
      ...
      <div className="flex">
        ...
        <div className="text-md mt-2 mb-4 px-7 font-thin leading-tight sm:mx-32 sm:leading-loose lg:leading-normal">
